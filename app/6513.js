  ...
  [6513, 2899],
  {
    ...
    16513: (t, n, e) => {
      ...
      var s = e(50959),
        ...
        a = e(13855),
        i = e(36458);
      const r = "tvd:settings-provider-service";
      var c = e(29649),
        l = e(52899);
      function d(t) {
        return s.createElement(l.default, {
          ...
          onClick: () => {
            (async () => {
              const t = await i.i.provideProxy(r).getFileSavePath();
              (await o.shell.openPath(t).catch((n) => {
                (0, a.x$)().error(
                  `<DownloadToast>.onToastClick(): shell.openPath(path: ${t}) error`,
                  n,
                );
              }),
                (0, c.P8)().hideToast());
    ...
    52899: (t, n, e) => {
      ...
      var d = e(25211),
        ...
        y = e(91378),
        P = {};
      ((P.styleTagTransform = k()),
        (P.setAttributes = x()),
        (P.insert = g().bind(null, "head")),
        (P.domAPI = h()),
        (P.insertStyleElement = w()),
        p()(y.Z, P),
