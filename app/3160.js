...
(global.webpackChunktradingview_desktop =
  ...
  [3160, 6486],
  {
    84434: (e, t, n) => {
      ...
      function p(e) {
        const t = (0, i.s3)(),
          n = (0, i.aF)(),
          s = (0, i.nZ)(),
          { release: u, environment: c = o.J } = (t && t.getOptions()) || {},
          { userAgent: l } = r.n.navigator || {},
          p = (0, a.Hv)({
            release: u,
            environment: c,
    ...
    96486: (e, t, n) => {
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  return s || !i || "string" != typeof n
                    ? s
                    : R(this.data && this.data[e] && this.data[e][t], n, o);
                },
              },
              {
                key: "addResource",
                  ...
                  value: function (e, t, n) {
                    ...
                    if (f && "cimode" === f.toLowerCase()) {
                      if (g) {
                        ...
                        return i
                          ? {
                              res: "".concat(l).concat(h).concat(u),
                              usedKey: u,
                              exactUsedKey: u,
                              usedLng: f,
                              usedNS: l,
                            }
                          : "".concat(l).concat(h).concat(u);
                      }
                      return i
                        ? {
                            res: u,
                    ...
                    if (
                      ...
                      if (a) {
                        ...
                        for (var P in v)
                          if (Object.prototype.hasOwnProperty.call(v, P)) {
                            var L = "".concat(j).concat(a).concat(P);
                            ((w[P] = this.translate(
                              L,
                              F(F({}, t), { joinArrays: !1, ns: c }),
                            )),
                              w[P] === L && (w[P] = v[P]));
                          }
                        v = w;
                      ...
                      var R = !1,
                        ...
                        E = p.hasDefaultValue(t),
                        D = C
                          ? this.pluralResolver.getSuffix(f, t.count, t)
                          : "",
                        Z = t["defaultValue".concat(D)] || t.defaultValue;
                      (!this.isValidLookup(v) && E && ((R = !0), (v = Z)),
                        this.isValidLookup(v) || ((N = !0), (v = u)));
                      var I =
                          ...
                          N
                            ? void 0
                            : v,
                        A = E && Z !== v && this.options.updateMissing;
                      if (N || R || A) {
                        if (
                          (this.logger.log(
                        ...
                        if (
                          ...
                          for (var K = 0; K < U.length; K++) V.push(U[K]);
                        else
                        ...
                        var B = function (e, n, r) {
                          ...
                          (o.options.missingKeyHandler
                            ? o.options.missingKeyHandler(e, l, n, i, A, t)
                            : o.backendConnector &&
                              o.backendConnector.saveMissing &&
                              o.backendConnector.saveMissing(e, l, n, i, A, t),
                            o.emit("missingKey", e, l, n, v));
                        };
                      ...
                      ((v = this.extendTranslation(v, e, t, d, n)),
                        N &&
                          v === u &&
                  ...
                  value: function (e, t, n, r, o) {
                    ...
                    if (this.i18nFormat && this.i18nFormat.parse)
                      e = this.i18nFormat.parse(
                        e,
                        F(
                          F({}, this.options.interpolation.defaultVariables),
                          n,
                        ),
                        r.usedLng,
                        r.usedNS,
              ...
              (this.rules =
                ...
                U.forEach(function (e) {
                  e.lngs.forEach(function (t) {
                    n[t] = { numbers: e.nr, plurals: K[e.fc] };
                  });
                }),
                n)));
          }
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                for (; (n = this.nestingRegexp.exec(e)); ) {
                  var u = [];
                  (((o =
                    (o = z({}, a)).replace && "string" != typeof o.replace
                      ? o.replace
                    ...
                    c &&
                      (r = u.reduce(function (e, t) {
                        return i.format(
                          ...
                          t,
                          a.lng,
                          z(z({}, a), {}, { interpolationkey: n[1].trim() }),
                        );
                      }, r.trim())),
                    (e = e.replace(n[0], r)),
      ...
      var G = (function () {
        function e() {
          ...
          ((0, o.Z)(this, e),
            ...
            (this.options = t),
            (this.formats = {
              number: Y(function (e, t) {
                var n = new Intl.NumberFormat(e, W({}, t));
                return function (e) {
                  return n.format(e);
                };
              }),
              currency: Y(function (e, t) {
                var n = new Intl.NumberFormat(
                  e,
                  W(W({}, t), {}, { style: "currency" }),
                );
                return function (e) {
                  return n.format(e);
                };
              }),
              datetime: Y(function (e, t) {
                var n = new Intl.DateTimeFormat(e, W({}, t));
                return function (e) {
                  return n.format(e);
                };
              }),
              relativetime: Y(function (e, t) {
                var n = new Intl.RelativeTimeFormat(e, W({}, t));
                return function (e) {
                  return n.format(e, t.range || "day");
                };
              }),
              list: Y(function (e, t) {
                var n = new Intl.ListFormat(e, W({}, t));
                return function (e) {
                  return n.format(e);
                };
              }),
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                (this.queue.forEach(function (n) {
                  ...
                  ((r = n.loaded),
                    (s = i),
                    ((c = (u = b(r, [o], Object)).obj)[(l = u.k)] = c[l] || []),
                    c[l].push(s),
                    (function (e, t) {
                      void 0 !== e.pending[t] &&
        ...
        return {
          ...
          overloadTranslationOptionHandler: function (e) {
            ...
            if (
              ...
              "object" === (0, r.Z)(e[2]) || "object" === (0, r.Z)(e[3]))
            ) {
              var n = e[3] || e[2];
        ...
        function p() {
          ...
          if (
            ...
            if (!e.options.initImmediate)
              return (e.init(n, r), (0, u.Z)(e, (0, a.Z)(e)));
            setTimeout(function () {
              e.init(n, r);
            }, 0);
          }
          ...
          (0, i.Z)(p, [
            {
              ...
              value: function () {
                ...
                if (
                  ((this.options = oe(oe(oe({}, r), this.options), ne(t))),
                  "v1" !== this.options.compatibilityAPI &&
                    (this.options.interpolation = oe(
                      oe({}, r.interpolation),
                      this.options.interpolation,
                    )),
                  void 0 !== t.keySeparator &&
                  ...
                  ((s.logger = d),
                    ...
                    (s.interpolator = new $(this.options)),
                    (s.utils = {
                      hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
                    }),
                    (s.backendConnector = new ee(
                    ...
                    return (
                      (l =
                        a.keyPrefix && Array.isArray(t)
                          ? t.map(function (e) {
                              return "".concat(a.keyPrefix).concat(p).concat(e);
                            })
                          : a.keyPrefix
                            ? "".concat(a.keyPrefix).concat(p).concat(t)
                            : t),
                      o.t(l, a)
                    );
                  };
            ...
            },
            {
              ...
              value: function (e) {
                if (
                  ...
                  return "rtl";
                var t =
                  (this.services && this.services.languageUtils) || new V(te());
                return [
                  "ar",
                  "shu",
                  "sqr",
                ...
                var e = this,
                  ...
                  n =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ? arguments[1]
                      : ie,
                  r = oe(oe(oe({}, this.options), t), { isClone: !0 }),
                  o = new p(r);
                return (
      ...
      (0, l.Z)(ae, "createInstance", function () {
        return new ae(
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      ((se.createInstance = ae.createInstance),
        se.createInstance,
        se.dir,
        se.init,
        se.loadResources,
